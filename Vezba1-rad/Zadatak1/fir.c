...
Int16 fir_basic_opt_dec(Int16 input, Int16* coeffs, Int16 *history, Uint16 n_coeff)
{
	Int16 i;
...
Int16 fir_basic_opt_int(Int16 input, Int16* coeffs, Int16 *history, Uint16 n_coeff,Int16 index)
{
	Int16 i;
